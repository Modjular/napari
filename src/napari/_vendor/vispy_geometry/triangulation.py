# Vendored verbatim from vispy/geometry/triangulation.py, with only the
# `_cross_2d` import repointed at the sibling `_helpers` module.
# See _helpers.py for why, and for the vispy BSD licence notice.
# -*- coding: utf-8 -*-
...
from napari._vendor.vispy_geometry._helpers import _cross_2d
